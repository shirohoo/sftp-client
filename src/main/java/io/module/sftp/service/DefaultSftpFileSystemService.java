...
public class DefaultSftpFileSystemService implements SftpFileSystemService {
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(DefaultSftpFileSystemService.class);
    
    private static final String SESSION_properties_STRICT_HOST_KEY_CHECKING = "StrictHostKeyChecking";
    
    private final SftpProperties properties;
    
    public DefaultSftpFileSystemService(SftpProperties properties) {
    ...
    public File download(String targetPath, String downloadPath) throws Exception {
        ...
        String location = downloadPath.substring(0, index);
